...
def get_model_and_config(model_args: argparse.Namespace): 
    ...
    #logger.info(f"Using dropout with probability {model_args.use_dropout}")
...
def main():  
    ...
    def compute_metrics(p: EvalPrediction):
        ...
        bert = bertscore.compute(predictions=predictions, references=labels, model_type='bert-base-multilingual-cased')
