...
class ThisSeq2SeqTrainer(Seq2SeqTrainer):
    def prediction_step(
        self,
        model: nn.Module,
...
class PIXELSumModel(PreTrainedModel):
    r"""
    ...
    """
    config_class = PIXELSumConfig
    base_model_prefix = 'pixelsum'
    ...
    def __init__(
        ...
        if config is None:
            config = PIXELSumConfig.from_encoder_decoder_configs(encoder.config, decoder.config)
        else:
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs
        ...
        if decoder is None:
            ...
            if 'gpt' in decoder_pretrained_model_name_or_path:
                # Cross attention factor... 
